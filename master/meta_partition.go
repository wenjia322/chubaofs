...
func (mp *MetaPartition) createTaskToResetRaftMembers(newPeers []proto.Peer, newLearners []proto.Learner, address string) (t *proto.AdminTask, err error) {
	req := &proto.ResetMetaPartitionRaftMemberRequest{PartitionId: mp.PartitionID, NewPeers: newPeers, NewLearners: newLearners}
